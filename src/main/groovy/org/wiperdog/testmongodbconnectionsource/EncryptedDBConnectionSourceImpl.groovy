...
//			logger.info ("After 20 times try to connect with " + connstr + " " + dbuser + "/" + replacePasswdString(strPassword) + ". Cannot connect!")
			println ("After 20 times try to connect with " + connstr + " " + dbuser + "/" + replacePasswdString(strPassword) + ". Cannot connect!")
		}
	}
...
//						logger.info (MessageFormat.format(mapMessage['ERR001'], "'" + connstr, dbuser, replacePasswdString(strPassword) + "'"))
						println (MessageFormat.format(mapMessage['ERR001'], "'" + connstr, dbuser, replacePasswdString(strPassword) + "'"))
						sleep(500)
					}
				}
			}
